...
public class Constants {
	...
	public static final String APP_ID = "wx0ca338b9cfb6df43"; //appid
	
	public static final String APP_SECRET = "9f5ca652ce47f3949c93e22aa1ecfb0e"; //密钥
	
	public static final String MCH_ID = "1502069471"; //微信商户平台商户号
	
	public static final String KEY = "FXQawNYUxSdBAAe1OTswSOA1aajOCvn1"; //微信商户平台执行操作需要的key
